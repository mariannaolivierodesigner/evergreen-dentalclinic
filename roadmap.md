...
- [ ] Indisponibilità ricorrenti (mensile/annuale) per lo staff
- [ ] Export del calendario filtrato (medico + intervallo) in CSV e PDF
- [ ] Creazione rapida di un'indisponibilità dal calendario (date + fascia oraria)
